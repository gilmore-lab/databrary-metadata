...
message("Regenerating all data.")

message("Gathering NSF-funded projects from Databrary.")
...
message("Adding funding details from NSF.gov")
...
A next step would be to identify the PIs on these volumes and contact them.
